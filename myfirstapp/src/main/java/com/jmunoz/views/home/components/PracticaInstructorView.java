...
@Route("practicaInstructor")
public class PracticaInstructorView extends VerticalLayout {

    public PracticaInstructorView() {
        setSizeFull();
    ...
    private void createFooter() {
        ...
        H6 lblFooter = new H6("© 2025 Jmmm. All Rights Reserved. Empowering Learners with Cutting-Edge Tech Skills. Follow Us and Contact US if you need.");
    ...
    private VerticalLayout createLeftContent() {
        ...
        panelServices.add(createContentAccordion(createStyledAnchor("#", "Consultation"),
        ...
        panelAbout.add(createContentAccordion(createStyledAnchor("#", "About Us"),
                createStyledAnchor("#", "Contact Us")));

        AccordionPanel panelPortfolio = new AccordionPanel();
        panelPortfolio.setSummaryText("PortFolio");
        panelPortfolio.add(createContentAccordion(createStyledAnchor("#", "Content Management System"),
    ...
    private VerticalLayout createCenterContent() {
        ...
        gridPerson.addClassName("person-grid-instructor");
        ...
        gridPerson.addColumn(Person::getAge, "age").setHeader("Age").setSortable(true).setSortProperty("age");
        ...
        })).setHeader("Gender").setComparator(Person::getGender)
                .setSortProperty("gender").setWidth("5px").setTooltipGenerator(Person::getGender);
        gridPerson.addColumn(Person::getSalary).setHeader("Salary ($}")
                .setTextAlign(ColumnTextAlign.END).setWidth("20px");
        gridPerson.addColumn(Person::getProfession, "profession").setHeader("Profession")
    ...
    private FormLayout createRightContent() {
        ...
        Icon iconDollar = VaadinIcon.DOLLAR.create();
        iconDollar.setColor("goldenrod");
        salary.setSuffixComponent(iconDollar);
